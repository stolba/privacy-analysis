(define (problem p01) (:domain manufact)
(:objects
	id-1 - id
	id-2 - id
	console-1 - console
...
(:init
	(available id-1)
	(available id-2)
	(factory-produces-engine factory-1)
	(factory-produces-interior factory-1)
	(factory-produces-chassis factory-1)
	...
	(factory-at factory-1 factory-location-1)
)
(:goal
	(and
